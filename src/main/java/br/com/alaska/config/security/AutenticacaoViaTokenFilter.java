...
import br.com.alaska.exceptions.user.UserNotFoundByIdException;
...
public class AutenticacaoViaTokenFilter extends OncePerRequestFilter {
    ...
    private void autenticarCliente(String token) {
        ...
        User usuario = userRepository.findById(idUsuario).orElseThrow(UserNotFoundByIdException::new);
